...
class SubackImpl;
class Suback : public cc_tools_qt_plugin::cc_mqttsn::Message
{
public:
    Suback();
    ...
    virtual ~Suback();
    Suback& operator=(const Suback& other);
    Suback& operator=(Suback&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(19U); }
...
private:
    std::unique_ptr<SubackImpl> m_pImpl;
};

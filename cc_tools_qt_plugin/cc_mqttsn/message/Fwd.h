...
class FwdImpl;
class Fwd : public cc_tools_qt_plugin::cc_mqttsn::Message
{
public:
    Fwd();
    ...
    Fwd(Fwd&&) = delete;
    virtual ~Fwd();
    Fwd& operator=(const Fwd& other);
    Fwd& operator=(Fwd&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(254U); }
...
private:
    std::unique_ptr<FwdImpl> m_pImpl;
};

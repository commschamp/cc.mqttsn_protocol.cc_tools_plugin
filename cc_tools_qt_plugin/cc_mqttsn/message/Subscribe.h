...
class SubscribeImpl;
class Subscribe : public cc_tools_qt_plugin::cc_mqttsn::Message
{
public:
    Subscribe();
    ...
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(18U); }
...
private:
    std::unique_ptr<SubscribeImpl> m_pImpl;
};

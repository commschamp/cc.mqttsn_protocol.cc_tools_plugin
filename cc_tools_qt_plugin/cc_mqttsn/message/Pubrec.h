...
class PubrecImpl;
class Pubrec : public cc_tools_qt_plugin::cc_mqttsn::Message
{
public:
    Pubrec();
    ...
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(15U); }
...
private:
    std::unique_ptr<PubrecImpl> m_pImpl;
};
